...
const Info = () => {
	...
	const [followers, followings] = useUserStore(
		(state) => [state.followers, state.followings],
		shallow,
	)
				...
				<div className="-translate-y-[1rem] text-center">
					...
					<div className="flex mt-[2rem] justify-between w-[10rem]">
						<div className="flex flex-col items-center">
							<div className="font-bold text-white">{followers?.length}</div>
						...
						>
							<div className="font-bold text-white">{followings?.length}</div>
