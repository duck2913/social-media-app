		...
		<div className="h-screen p-4">
			<Card className="rounded-xl p-10 relative">
				...
				<div onClick={logoutHandler}>
					<BiLogOut className="absolute right-5 top-5 w-[2rem] h-[2rem] bg-purple-400 rounded-full p-1 cursor-pointer active:-translate-y-2 transition-all text-purple-700" />
				</div>
			</Card>
		</div>
	)
